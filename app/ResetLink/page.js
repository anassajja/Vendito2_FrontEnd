...
const SendResetLink = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('We have emailed your password reset link',response.data);
    ...
    return (
      <main id="content" role="main" className="w-full  max-w-md mx-auto p-6">
              ...
              <form onSubmit={handleSubmit}>
                <div className="grid gap-y-4">
                    ...
                    <div className="relative">
                        <input type="email" id='email' name='email' onChange={e => setEmail(e.target.value)} placeholder="Email" aria-describedby="email-error" className="py-3 px-4 block w-full border-2 border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 shadow-sm" required />
                    </div>
        ...
        <p className="mt-3 flex justify-center items-center text-center divide-x divide-gray-300 dark:divide-gray-700">
            ...
            &nbsp;
            <Link href="/home" className='pl-3 inline-flex items-center gap-x-2 text-sm text-gray-600 decoration-2 hover:underline hover:text-blue-600 dark:text-gray-500 dark:hover:text-gray-200'>Home</Link>
        </p>
      </main>
    );
};
