        ...
        <div className="max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-between">
            ...
            <ul>
                ...
                <div className="flex flex-row items-start mb-5">
                    ...
                    style={{ backgroundColor: '#6b46c1', color: '#fff', borderColor: '#fff' }}>
                    {/* SVG */}
                ...
                <div className="flex flex-row items-start">
                    ...
                    <p className="text-gray-700 text-sm">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione. Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
                    </div>
                ...
                <div className="flex flex-row items-start mb-5">
                    ...
                    <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                    <h4 className="text-md leading-6 font-medium text-gray-900">
                        What could possibly be your second question?
                    </h4>
                    </div>
                </div>
                <div className="flex flex-row items-start">
                ...
                <div className="flex flex-row items-start mb-5">
                    ...
                    <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                    <h4 className="text-md leading-6 font-medium text-gray-900">
                        What could possibly be your third question?
                    </h4>
                    </div>
                </div>
                <div className="flex flex-row items-start">
